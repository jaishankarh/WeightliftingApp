...
class Ui_MembersWindow(object):
    ...
    def setupUi(self, MembersWindow):
        ...
        self.db = QtSql.QSqlDatabase.addDatabase("QSQLITE")
        self.db.setDatabaseName("utils/example.db")
        self.model =  QSqlTableModel()
        self.model.setTable("PARTICIPANT")
    ...
    def retranslateUi(self, MembersWindow):
        ...
        self.save_btn.setText(QApplication.translate("MembersWindow", "Save", None, QApplication.UnicodeUTF8))
